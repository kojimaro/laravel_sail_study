<div>
    ...
    <div class="grid grid-cols-4 gap-4">
        @foreach ($scraps as $scrap)
            <div class="rounded shadow-lg bg-white px-4">
                <div class="my-3 pl-2.5">
                    {{ $scrap->body }}
                </div>
                <hr>
                <div>
                    <button type="button" class="text-gray-900 bg-white focus:outline-none focus:ring-4 focus:ring-gray-100 font-medium text-sm p-2.5 me-2 hover:text-sky-500">
